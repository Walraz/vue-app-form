...
type Options = { label: string, value: string | number, caption?: string | number, disable?: boolean }[]
...
const filteredOptions = computed(() => {
  return [...customOptions.value, ...props.options].filter(x => !filterVal.value || `${x.value}`.toLocaleLowerCase().includes(filterVal.value))
})
